...
MFCApplication1Dlg.h, MFCApplication1Dlg.cpp — диалоговое окно
    Эти файлы содержат класс CMFCApplication1Dlg. Этот класс определяет поведение главного диалогового окна приложения. Шаблон диалогового окна находится в файле MFCApplication1.rc, который можно изменять с помощью Microsoft Visual C++.
